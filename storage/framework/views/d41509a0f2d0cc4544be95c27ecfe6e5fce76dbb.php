    ...
    <!-- settings start -->
        ...
        <li id="header_inbox_bar" class="dropdown">
            ...
            <ul class="dropdown-menu extended inbox">
                ...
                <li>
                    <a href="#">
                        <span class="photo"><img alt="avatar" src="<?php echo e(asset('images/1.png')); ?>"></span>
                        <span class="subject">
                ...
                <li>
                    <a href="#">
                        <span class="photo"><img alt="avatar" src="<?php echo e(asset('images/2.png')); ?>"></span>
                        <span class="subject">
        ...
        <div class="leftside-navigation">
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li >
                    ...
                    <ul class="sub">
                        <li ><a class="active" href="<?php echo e(url('artikel')); ?>">Artikel Utama</a></li>
...
<div class="footer">
    <div class="wthree-copyright">
        <p>
            © 2017 Visitors. All rights reserved | Design by <a href="http://w3layouts.com">W3layouts</a>
        </p>
    </div>
</div>
...
<!--[if lte IE 8]><script language="javascript" type="text/javascript" src="<?php echo e(asset('js/flot-chart/excanvas.min.js')); ?>"></script><![endif]-->
...
<!-- calendar -->
<script type="text/javascript" src="<?php echo e(asset('js/monthly.js')); ?>"></script>
